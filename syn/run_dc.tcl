...
analyze -format verilog -lib WORK verilog/fifo_depth16.v
analyze -format verilog -lib WORK verilog/fifo_mux_16_1.v
analyze -format verilog -lib WORK verilog/fifo_mux_8_1.v
analyze -format verilog -lib WORK verilog/fifo_mux_2_1.v
